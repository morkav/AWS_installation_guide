...
[program:name\_project]
command=/home/ubuntu/.pyenv/versions/name\_project\_env/bin/gunicorn name\_project.wsgi:application -b 127.0.0.1:8005 -w 4 -t 30
...
sudo supervisorctl restart program\_name
